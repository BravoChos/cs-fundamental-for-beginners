...
// Client 2
const readingClient2 = acquireReading();
export const taxableCharge = readingClient2.taxableCharge;
console.log(taxableCharge);

// Client 3
const readingClient3 = acquireReading();
const basicChargeAmount = readingClient3.baseCharge;
